      ...
      !(function (e) {
        ...
        let p = (() => {
          class L {
            ...
            runTask(t, o, y) {
              ...
              if (t.state === j && (t.type === R || t.type === A)) return;
              const P = t.state != X;
        ...
        class m {
          ...
          _transitionTo(_, t, o) {
            ...
            (this._state = _), _ == j && (this._zoneDelegates = null);
          }
          toString() {
      ...
      function Tt(e, n, i) {
          ...
          D = function (E) {
            ...
            if (M)
              if (1 === M.length) Z(M[0], d, E);
                ...
                const z = M.slice();
                for (let j = 0; j < z.length && (!E || !0 !== E[Ve]); j++)
                  Z(z[j], d, E);
              }
          },
          I = function (E) {
        ...
        function B(E, d) {
          ...
          const _ = M
              ...
              : function (s) {
                  return Y.call(H.target, H.eventName, s.invoke, H.options);
                },
            t = M
              ? function (s) {
                  if (!s.isRemoved) {
          ...
          return (
            ...
            ee &&
              (O.prependListener = l(
                ...
                ".prependListener:",
                function (s) {
                  return ee.call(H.target, H.eventName, s.invoke, H.options);
                },
                t,
                q,
                !0
        ...
        Zone.__load_patch("XHR", (e, n) => {
          !(function (T) {
            ...
            const j = ue(
                ...
                () =>
                  function (v, A) {
                    return (v[r] = 0 == A[2]), (v[f] = A[1]), j.apply(v, A);
                  }
              ),
              ...
              H = ue(
                ...
                () =>
                  function (v, A) {
                    if (!0 === n.current[X] || v[r]) return H.apply(v, A);
                    {
                      const R = {
                          target: v,
                          url: v[f],
            ...
            (function (e, n) {
              ...
              for (let r = 0; r < n.length; r++) {
                ...
                if (u) {
                  ...
                  e[c] = ((p) => {
                    const g = function () {
                      return p.apply(this, je(arguments, i + "." + c));
                    };
                    return fe(g, p), g;
                  })(u);
                }
    ...
    430: (De, de, Te) => {
      const _e = "undefined" != typeof globalThis && globalThis,
        ...
        He =
          ...
          self instanceof WorkerGlobalScope &&
          self,
        Ce = _e || ("undefined" != typeof global && global) || Ae || He,
        me = function ($, ...ne) {
          if (me.translate) {
